...
public class SwaggerConfiguration {
	...
	public Docket postsApi() {
		return new Docket(DocumentationType.SWAGGER_2).groupName("happyhouse").apiInfo(this.apiInfo()).select()
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Happy House API")
				.description("<h3>SSAFY API Reference for Developers</h3>Final PJT HappyHouse API")
